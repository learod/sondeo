       ...
       function alertDismissed(button) {
        ...
        $(document).ready(function() {
            ...
            $("#g_pass").click(function(e){
                e.preventDefault();
                var url ="/users/cambiar_pass.json";    
                $.ajax({
                  url: url,
            ...
            $("#periodo_button").click(function(e){
                e.preventDefault();
                var url ="/ciudadanos/periodos.json?id="+login.ciudadano.id;    
                $.ajax({
                  url: url,
                  timeout: 10000,
                  type:'get',
            ...
            $("#anteproyectos_button").click(function  () {
              ...
              $('#col_set').html("");
              var url ="/ciudadanos/"+login.ciudadano.id+"/anteproyectos.json";
                  $.ajax({
                    url: url,
                    // data: {id: id},
                    timeout: 10000,
        ...
        function carga_periodo(id,ley){
            ...
            leyenda=ley;
            var url ="/periodo_propuestas/propuestas.json?id="+id;    
                $.ajax({
                  url: url,
                  timeout: 10000,
                  type:'get',
        ...
        function carga_anteproyecto(id){
            ...
            periodo_propuesta_id=id;
            leyenda=ley;
            var url ="/ciudadanos/propuesta.json";    
                $.ajax({
                  url: url,
                  data: {id: id},
                  timeout: 10000,
